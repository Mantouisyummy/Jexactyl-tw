...
export default () => (
    <PageContentBlock title={'帳戶安全'} description={'管理帳戶紀錄和驗證.'}>
        <Container css={tw`lg:grid lg:grid-cols-3 my-10`}>
            <div css={tw`flex-none w-full col-span-1`}>
                <ContentBox className={'j-right'} title={'更新密碼'} showFlashes={'account:password'}>
                    <UpdatePasswordForm />
                </ContentBox>
                <ContentBox className={'j-right'} title={'設定 2FA'} css={tw`mt-8`} showFlashes={'account:2fa'}>
